...
public class LollapaloozerServiceImplSafe extends RemoteServiceServlet implements LollapaloozerService {
  private static final Logger log = Logger.getLogger(LollapaloozerServiceImplSafe.class.getName());
...
@Override
public String insertSetData() throws IllegalArgumentException {
...
@Override
public String deleteRatingsByYear(Integer year) throws IllegalArgumentException {
	// TODO Auto-generated method stub
	return null;
}
}
