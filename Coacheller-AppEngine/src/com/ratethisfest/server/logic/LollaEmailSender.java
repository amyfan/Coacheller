...
public class LollaEmailSender extends EmailSender {
  ...
  public LollaEmailSender(String authType, String authId, String authToken, String email) {
    this.festival = FestivalEnum.LOLLAPALOOZA;
