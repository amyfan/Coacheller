...
public class LollaEmailSenderSafe {
  ...
  /*
   * TODO: update once user auth implemented for lolla
   */
  private static String generateMessageBody(String email) {
    // TODO: don't constrain by (& definitely don't hardcode) year here
    List<Rating> ratings = LollaRatingManager.getInstance().findRatingsByUserEmailAndYear(email, 2012);
    if (ratings == null) {
      return null;
    }
